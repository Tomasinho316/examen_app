...
class ProductService extends ChangeNotifier {
  ...
  Future loadProducts() async {
    ...
    try {
      ...
      final productsMap = Product.fromJson(json.decode(response.body));
      products = productsMap.listado;

    } catch (e) {
      print('Error procesando productos: $e');
      products = []; // así evitas que quede cargando eternamente
    }
  ...
  Future createProduct(Listado product) async {
    ...
    try {
      ...
      loadProducts(); // para actualizar lista tras creación

    } catch (e) {
      debugPrint('Error procesando productos: $e');
    }
